...
from PySide6.QtWidgets import (
    ...
    QStackedWidget, QPushButton, QLabel, QFrame, QGridLayout, QSpacerItem, QSizePolicy
)
...
class ITHelperApp(QMainWindow):
    ...
    def _create_sidebar(self):
        ...
        home_btn.setFont(QFont("Segoe UI Emoji", 14))
        ...
        # Utility buttons
        utilities = [
            ("📶", "Wi-Fi Scanner", self._show_wifi_scanner),
            ("📊", "Wi-Fi Charts", self._show_wifi_charts),
            ("💾", "Disk Space Analyzer", self._show_disk_analyzer),
            ("🖥", "System Info", self._show_system_info),
            ("🌐", "Network Scanner", self._show_network_scanner)
        ]
    ...
    def _handle_auto_navigation(self):
        ...
        if self.args.open_disk_analyzer:
